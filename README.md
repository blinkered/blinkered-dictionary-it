# Blinkered dictionary: Italian

The Italian word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Italian.

**40,702 of 40,944 candidates proved — 99.4%**, across 7 independent
families, 5 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Italian, and why those
...
Candidates come from Blinkered's Italian list, which lives in
[`blinkered-attestation/candidates/it`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/it).
